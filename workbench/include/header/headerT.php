<?php
	...
	$result = $db->ud_getQuery('SELECT * FROM `ud_subject` s JOIN `ud_subjects_users` u ON s.subjectID = u.subjectID WHERE u.userID = '.$_SESSION['userID']);
	$subA = array();
	$countA = 0;
	$subM = array();
	$countM = 0;
...
<div class="banner">
	<div class="row">
		<div class="two columns hide-for-small">
			<img src="../../resources/images/music.png" width="80%"> </div>
		<div class="six columns mobile-four">
			<h3 style="text-align: left;"><?php echo  $course['subjectName']; ?></h3>
			<div class="row banner-quicklinks">
				<div class="four columns">
					<a href="profile.php"><?php echo $_SESSION['userLogin']; ?></a> </div>
				<div class="four columns">
					<a href="#">Follow</a> </div>
				<div class="four columns">
					<a href="#">Add Students</a> </div>
			</div>
		</div>
		<div class="four columns">
		</div>
		...
		<div class="row">
			<div class="twelve columns mobile-four">
				<ul class="nav-bar">
					...
					<li class="has-flyout"><a href="#">Question Bank</a>
					<a class="flyout-toggle" href="#"><span></span></a>
					<ul class="flyout">
						<li><a href="questionbank.php?subjectID=<?php echo $course['subjectID']; ?>">Questions</a></li>
						<li><a href="category.php?subjectID=<?php echo $course['subjectID']; ?>">Categories</a></li>
						<li><a href="#">Import</a></li>
						<li><a href="#">Export</a></li>
					</ul>
					</li>
					<li class="has-flyout"><a href="#">Participant</a>
					<a class="flyout-toggle" href="#"><span></span></a>
					<ul class="flyout">
						<li><a href="participants.php?subjectID=<?php echo $course['subjectID']; ?>&activeType=Active">Enrolled</a></li>
						<li><a href="participants.php?subjectID=<?php echo $course['subjectID']; ?>&activeType=Debarred">Debarred</a></li>
						<li><a href="participants.php?subjectID=<?php echo $course['subjectID']; ?>&activeType=All">Add/Remove</a></li>
					</ul>
					</li>
					...
					<a class="flyout-toggle" href="#"><span></span></a>
					<ul class="flyout">
						<li><a href="quiz.php?subjectID=<?php echo $course['subjectID']; ?>">Manage Quiz</a></li>
					</ul>
					</li>
